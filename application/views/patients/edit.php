...
<label for="patient_name">Voornaam</label><input name="patient_name" type='text'
                                                 value= <?php echo $editContent['patient_name']; ?>>
<br/>
...
<label for="patient_status">Status</label><input name="patient_status" type='text'
...
<select name="client_firstname" class="dropdown" <?php echo $editContent['patient_name']; ?>>
    <?php foreach ($firstnaam as $naam): ?>
        <option value="<?php echo $naam->client_firstname ?>"<?php if ($editContent['client_firstname'] == $naam->client_firstname) {
            echo 'selected';
        } ?>><?php echo $naam->client_firstname ?></option>
    <?php endforeach; ?>
</select><br>
<label for="gender">gender</label>
<input type="radio" name="gender" value="male"<?php if ($editContent['gender'] == 'male') {
    echo 'checked';
} ?> > Male
<input type="radio" name="gender" value="female"<?php if ($editContent['gender'] == 'female') {
    echo 'checked';
} ?>> Female<br>
